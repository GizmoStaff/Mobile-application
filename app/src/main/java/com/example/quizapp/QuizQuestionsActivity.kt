...
class QuizQuestionsActivity : AppCompatActivity(),View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ivImage=findViewById(R.id.iv_dishimage)
   ...
   private fun defaultOptionsView(){
    ...
    private fun isOptionSelected(tv:TextView,selectedOptionNum:Int){
        defaultOptionsView()

        mSelectedOptionPosition=selectedOptionNum

        tv.setTextColor(Color.parseColor("#5a189a"))
    ...
    override fun onClick(view: View?) {
        ...
        when(view?.id){
            R.id.tv_optionOne ->{
                tvOptionOne?.let{
                    isOptionSelected(it,1)
                }
            }

            R.id.tv_optionTwo ->{
                tvOptionTwo?.let{
                    isOptionSelected(it,2)
                }
            }
            R.id.tv_optionThree->{
                tvOptionThree?.let{
                    isOptionSelected(it,3)
                }
            }

            R.id.tv_optionFour->{
                tvOptionFour?.let{
                    isOptionSelected(it,4)
                }
            }
